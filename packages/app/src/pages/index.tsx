...
import { WaitingListModal } from '../module/waiting-list/Modal';
import { useWhitelist } from '../hooks/useWhitelist';

const isActiveWhitelist = process.env.REACT_APP_WHITELIST_STATUS === 'active';

export default function IndexPage() {
  const account = useAccount();
  const checkIsWhitelisted = useWhitelist(isActiveWhitelist);
      ...
      <PageLayout>
        ...
        <WhatIsDCA>
          ...
          <WhatIsDCAPoint>
            ...
            <WhatIsDCAPointDescription>
              With Stackly, you can choose the token you want to stack, the frequency of the stacks, and when to start
              and end them, giving you greater control over your investments.
            </WhatIsDCAPointDescription>
          </WhatIsDCAPoint>
        </WhatIsDCA>
      </PageLayout>
      {isActiveWhitelist && account.address && !checkIsWhitelisted(account.address) && <WaitingListModal />}
    </>
  );
}

...
export function Mint() {
  ...
  return (
    <Container>
      ...
      <ButtonContainer>
        <ExternalLinkButton as="a" href="https://twitter.com/Stacklydapp" target="_blank">
      ...
      <ButtonContainer>
        <ExternalLinkButton as="a" href="https://discord.gg/QFkNsjTkzD" target="_blank">
...
const ExternalLinkButton = styled(WhiteButton)`
  align-items: center;
  justify-content: center;
  padding: 6px 10px;
  text-wrap: nowrap;
